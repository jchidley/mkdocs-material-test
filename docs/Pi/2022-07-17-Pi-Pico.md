...
!!! info "Reference"
    Pi Pico CircuitPython examples and MicroPython networking basics. For comprehensive Pi Pico coverage including PIO programming, simulators, installation, and hardware projects, see the [main Pi Pico doc](../2023-11-05-Pi-Pico.md).
...
For resilient WiFi code and Microdot web framework, see [Pi Pico - Networking](../2023-11-05-Pi-Pico.md#networking).
...
For comprehensive data monitoring with InfluxDB, Grafana, and Telegraf, see [Pi Pico - Data Monitoring and Visualization](../2023-11-05-Pi-Pico.md#data-monitoring-and-visualization).
