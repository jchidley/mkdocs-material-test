...
* [Field recording equipment — Mindful Audio](https://web.archive.org/web/2023/https://mindful-audio.com/gear)
...
* ~~Using a USB Audio Device With a Raspberry Pi~~ (link dead, no archive available)
