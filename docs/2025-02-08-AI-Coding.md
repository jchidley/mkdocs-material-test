...
- [Subscription Plans | Supadata](https://supadata.ai/pricing) for Web and YouTube Transcripts
...
- [Master Cursor AI App Development With These Simple Rules! - YouTube](https://www.youtube.com/watch?v=BtDxvAGhrjg)
- [Github Copilot Agent vs Cursor AI Which is BEST for Coding - YouTube](https://www.youtube.com/watch?v=V2tv6GZuV0A)
- [Full Stack App Build Claude 3.7 & Cursor AI - YouTube](https://www.youtube.com/watch?v=k0kBylMwlbA)
- [Cursor AI & Replit Connected - Build Anything - YouTube](https://www.youtube.com/watch?v=j30JWZJ07HM)
- [Cursor AI The Cheat Sheet Tutorial - YouTube](https://www.youtube.com/watch?v=2tb6mJt1HeU)
- [Clone Any App Design Effortlessly with Cursor AI - YouTube](https://www.youtube.com/watch?v=CrW1zSZtn1E)
- [Cursor Directory - Cursor Rules & MCP Servers](https://cursor.directory/)
- [bilal77511/custom-models-in-cursor-IDE](https://github.com/bilal77511/custom-models-in-cursor-IDE)
...
- [Terminal Chat | Microsoft Learn](https://learn.microsoft.com/en-gb/windows/terminal/terminal-chat)Most popular languages:
...
- [LLM Function Calling - AI Tools Deep Dive - YouTube](https://www.youtube.com/watch?v=gMeTK6zzaO4)
...
- [Copilot MCP - Visual Studio Marketplace](https://marketplace.visualstudio.com/items?itemName=AutomataLabs.copilot-mcp)
- [server-filesystem not working on my wsl remote · Issue #7 · VikashLoomba/copilot-mcp](https://github.com/VikashLoomba/copilot-mcp/issues/7)
- [A Single-File MCP Server, In TypeScript](https://www.aihero.dev/mcp-server-from-a-single-typescript-file)
...
- [Grok](https://x.com/i/grok?focus=1&conversation=1899784857066385581)
- [Private Search Engine - Brave Search](https://search.brave.com/)
- [Tavily](https://tavily.com/#pricing)

## More Links

- [ALucek (Adam Łucek)](https://github.com/ALucek)
- [spider - Rust](https://docs.rs/spider/latest/spider/index.html)
- [Spider Guides: Scrape & Crawl Agent with Microsoft's Autogen](https://spider.cloud/guides/crawl-agent-with-autogen)
- [AI – Lowry On Leadership](https://lowryonleadership.com/category/ai/)
- [AI – Lowry On Leadership](https://lowryonleadership.com/category/ai/)
- [The Power of Hybrid Graph RAG AI: Unlocking New Potential – Lowry On Leadership](https://lowryonleadership.com/2024/08/18/the-power-of-hybrid-graph-rag-ai-unlocking-new-potential/)
- [Automating Your AI Evaluation: A How-To Guide – Lowry On Leadership](https://lowryonleadership.com/2024/07/26/automating-your-ai-evaluation-a-how-to-guide/)
- [microsoft/graphrag: A modular graph-based Retrieval-Augmented Generation (RAG) system](https://github.com/microsoft/graphrag)
- [Debut of v1.0 of The Journey Sage Finder – Lowry On Leadership](https://lowryonleadership.com/2024/04/02/the-journey-sage-finder/)
- [LlamaIndex - Build Knowledge Assistants over your Enterprise Data](https://www.llamaindex.ai/)
- [Streamlit • A faster way to build and share data apps](https://streamlit.io/)
- [Streamlit](https://30days.streamlit.app/?challenge=Day3)
- [Rules for AI Prompting – Lowry On Leadership](https://lowryonleadership.com/2024/07/17/rules-for-ai-prompting/)
- [Troyusrex2/RAG-AI-Scaling](https://github.com/Troyusrex2/RAG-AI-Scaling?tab=readme-ov-file)
- [baehyunsol/ragit: git-like rag pipeline](https://github.com/baehyunsol/ragit?tab=readme-ov-file)
- [YouTube](https://www.youtube.com/)
- [LlamaIndex - LlamaIndex](https://docs.llamaindex.ai/en/stable/)
- [Animation demo](http://localhost:8501/animation_demo)
- [Basic concepts of Streamlit - Streamlit Docs](https://docs.streamlit.io/get-started/fundamentals/main-concepts
- [Using Spider.rs in Rust](https://chatgpt.com/c/67be2905-ff74-8010-b7c2-85056f025128)
- [llm-functions/mcp/server at main · sigoden/llm-functions](https://github.com/sigoden/llm-functions/tree/main/mcp/server)
- [Introducing the Model Context Protocol \ Anthropic](https://www.anthropic.com/news/model-context-protocol)
- [octocrab - Rust](https://docs.rs/octocrab/latest/octocrab/index.html)
- [Role Guide · sigoden/aichat Wiki](https://github.com/sigoden/aichat/wiki/Role-Guide)
...
- [17 Python Libraries Every AI Engineer Should Know](https://www.youtube.com/watch?v=p4G0coRey9w)
...
- [LangChain](https://github.com/langchain-ai) seems to be the main tool for AI stuff
